...
$form.Text = "Applications are installing"
...
if (Test-Path -Path $filePath -PathType Leaf) {
    ...
    $scriptPath = "c:\WINDOWS\system32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy Bypass -WindowStyle Minimized -noexit -command & '$TMTFolder\MasterScript.ps1'"
